    ...
    <header className="fixed top-0 left-0 w-full h-16 bg-[#141414] text-white flex items-center justify-between px-4 z-10">
      ...
      <nav className="flex items-center space-x-2">
        {isAuthenticated ? (
                ...
                <div className="absolute right-0 top-8 w-48 bg-[#141414] text-white rounded shadow-lg z-10">
                  ...
                  <button
                    onClick={() => {
                      ...
                      navigate('/'); // Navigate to PreSignUpPage
          ...
          <button
            onClick={() => navigate('/')} // Or navigate to a login page if you add one
            className="px-4 py-2 bg-[#e50914] text-white rounded hover:bg-red-700"
          >
            Sign In
          </button>
        )}
      </nav>
      {isAuthenticated && isMobileMenuOpen && ( // Only show mobile menu if authenticated
